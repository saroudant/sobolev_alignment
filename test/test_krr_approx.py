...
class TestKRRApprox():
    ...
    def test_rbf_sklearn_fit(
            self,
            fit_sklearn_rbf_ridge,
            valid_input,
            valid_embedding
    ):
    ...
    def test_rbf_falkon_fit(
            self,
            fit_falkon_rbf_ridge,
            valid_input,
            valid_embedding
    ):
    ...
    def test_ridge_coef_sklearn_fit(
        ...
        pred_reconstruct = fit_sklearn_laplacian_ridge.kernel_(valid_input,
                                                              input[fit_sklearn_laplacian_ridge.ridge_samples_idx_, :])
